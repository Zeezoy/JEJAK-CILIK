          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(
                        "Saat istirahat, beberapa teman tidak mau mengajak dimas bermain karena agamanya berbeda.",
                    ...
                    Image.asset("assets/misi/penguin1.png", width: 80),
                  ],
                ),
              ),
              ...
              Expanded(
                child: ListView(
                  children: [
                    answerButton("A", "Ikut bermain dengan teman lain saja", 1),
                    const SizedBox(height: 16),

                    answerButton("B", "Mengejek dimas bermain bersama", 2),
                    const SizedBox(height: 16),

                    answerButton(
                      "C",
                      "Membiarkannya karena takut dijauhi teman lain",
                      3,
                    ),
                    const SizedBox(height: 16),
                    ...
                    answerButton(
                      "D",
                      "Mengatakan pada teman bahwa mereka salah dengan marah",
                      4,
                    ),
                  ],
                ),
