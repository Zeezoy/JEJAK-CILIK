...
import 'package:jejak_cilik/kuis.dart';
import 'package:jejak_cilik/kuis3.dart';

class Kuis2 extends StatefulWidget {
  const Kuis2({super.key});
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Image.asset("assets/misi/penguin2.png", width: 80),
                    const SizedBox(width: 10),
                    Expanded(
                      child: Text(
                        "Saat kegiatan sekolah, seorang teman meminta izin untuk beribadah sesuai agamanya.",
              ...
              Expanded(
                child: ListView(
                  children: [
                    answerButton("A", "Mengejeknya karena berbeda", 1),
                    const SizedBox(height: 16),

                    answerButton(
                      "B",
                      "Membiarkannya dan tetap menghormati ",
                      2,
                    ),
                    const SizedBox(height: 16),

                    answerButton("C", "Menyuruhnya ikut kegiatan saja", 3),
                    const SizedBox(height: 16),

                    answerButton("D", "Menertawakannya bersama teman lain", 4),
                  ],
                ),
              ),
